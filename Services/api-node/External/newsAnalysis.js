...
export const get = async () => {
  try {
    ...
    console.log("invoked");
    const countryUrls = {
      1: "https://api.gdeltproject.org/api/v2/doc/doc?query=(NSE%20OR%20BSE%20OR%20Nifty%20OR%20Sensex%20OR%20%22NIFTY%2050%22)%20AND%20market&mode=artlist&timespan=16h&maxrecords=250&format=json,https://api.gdeltproject.org/api/v2/doc/doc?query=(NSE%20OR%20BSE%20OR%20Nifty%20OR%20Sensex%20OR%20%22NIFTY%2050%22)%20AND%20stocks&mode=artlist&timespan=10h&maxrecords=250&format=json,https://api.gdeltproject.org/api/v2/doc/doc?query=(NSE%20OR%20BSE%20OR%20Nifty%20OR%20Sensex%20OR%20%22NIFTY%2050%22)%20AND%20investors&mode=artlist&timespan=16h&maxrecords=250&format=json",
      // 2: "https://api.gdeltproject.org/api/v2/doc/doc?query=(%22S%26P%20500%22%20OR%20%22Dow%20Jones%22%20OR%20Nasdaq%20OR%20NYSE)&mode=artlist&timespan=10h&maxrecords=250&format=json",
